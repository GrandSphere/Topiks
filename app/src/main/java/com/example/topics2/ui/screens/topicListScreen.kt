   ...
   // viewModel.addTestData()
    ...
    Box(
        modifier = Modifier
            .fillMaxSize()
            .pointerInput(Unit) {
                detectTapGestures(onTap = { focusManager })
            }
    ) {
        Box(
            modifier = Modifier
            ...
            FloatingActionButton(
                onClick = { /* Navigate to add new topic screen */ },
                modifier = Modifier
...
fun TopicItem(
    ...
    Box(
        modifier = Modifier
            ...
            .pointerInput(Unit) {
                detectTapGestures( onTap = { _ -> onClick() }, onLongPress = { /* Handle long press */ })
            }
            .padding(8.dp)
    ) {
        ...
        DropdownMenu(
            expanded = false, // Replace with state management
            onDismissRequest = {}
        ) {
            DropdownMenuItem(
                text = { Text("Delete") },
